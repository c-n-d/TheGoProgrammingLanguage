/*
Exercise 5.12 - Convert startElement and endElement in to annonymous functions, where
                depth is local to the outline function.

$ go run src/ch5/ex_5_12/main.go https://google.com
<html>
  <head>
    <meta>
    </meta>
