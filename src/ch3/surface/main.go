/*
Surface computes a SVG rendering of a 3-D surface function

Modifided for Exercise 3.1, 3.3, 3.4

$ go run src/ch3/surface/main.go > src/ch3/surface/surface.html

To run this example as a web server:

$ go run src/ch3/surface/main.go -s
